 ...
 */
public class MenuAdapt extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private MenuItem menuItem;
    private Context context;
    private ShowPortions showPortions;
    public MenuAdapt(MenuItem menuItem, Context context, ShowPortions showPortions){
